...
type TimeoutFailoverSMSService struct {
	...
	// 切换的阈值，只读的
	threshold   int32
	rateLimiter limiter.Limiter // 新增 rateLimiter 字段

}

// func NewTimeoutFailoverSMSService(svcs []sms.Service, threshold int32) *TimeoutFailoverSMSService {
func NewTimeoutFailoverSMSService(svcs []sms.Service, threshold int32, rateLimiter limiter.Limiter) *TimeoutFailoverSMSService {
	return &TimeoutFailoverSMSService{
		svcs:        svcs,
		threshold:   threshold,
		rateLimiter: rateLimiter, // 初始化 rateLimiter 字段
	}
}
